...
const String kKeyPurpleTheam = 'purple';
const String kKeyBlueTheam = 'blue';
const String kKeyWhiteTheam = 'white';
const String kKeyRoleType = 'role';
const String kKeyISUser = 'customer';

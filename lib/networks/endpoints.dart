...
String? url = 'https://server-livesession8002-feusec-269c36-62-84-177-235.sslip.io';
...
final class Endpoints {
  ...
  static String editProfileUser({required String id}) => "/auth/users/$id/";
  static String buyerProfile({required String id}) => "/crm/buyers/$id/";
  ...
  static String resetOtpVerify() => "/auth/verify-otp";
  ...
  static String searchTag({required String query}) => "/tag/admintags/?search=$query";
  static String ads() => "/ads/";
  static String invoice() => '/invoice/';
  static String invoiceDetails({required String id}) => "/invoice/$id/";
  static String categories() => "/tag/categories/";
  static String subCategories({required String id}) => "/tag/categories/$id/tags/";
  static String trendingTags() => "/tag/admintags/trending/";
  static String supportSubmit() => "/support/submit/";
  static String companyPolicies() => "/crm/company-policies/";
  static String ownerPayoutMethods() => "/crm/owner-payout-methods/";
  static String deleteAccountRequest() => "/auth/account/delete/request";
  static String deleteAccountConfirm() => "/auth/account/delete/confirm";
  static String notifications() => "/invoice/notifications/";
  static String registerFcmToken() => "/fcm/devices/";
  
  // Seller endpoints
  static String vendorTags() => "/tag/vendortags/";
  static String adminTags() => "/tag/admintags/";
  static String shortNotes() => "/invoice/short-notes/";
  static String deleteShortNote({required String id}) => "/invoice/short-notes/$id/";
  static String payoutMethods() => "/auth/payout-methods/";
  static String editPayoutMethod({required String id}) => "/auth/payout-methods/$id/";
  static String deletePayoutMethod({required String id}) => "/auth/payout-methods/$id/";
  static String vendorDetails({required String id}) => "/crm/vendors/$id/";
}

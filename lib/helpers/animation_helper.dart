...
import 'package:bd_shope_combined/constants/app_assets/assets_lottie.dart';
...
imageSimmer(double? size) => (
  ...
  return Center(
    child: Lottie.asset(AssetsLotties.dataEmpty, height: size, width: size),
  );
};
